...
clear days. Total infrastructure cost: about \$26 cash and a small fraction of a \$200
cloud credit grant.
\end{abstract}
...
intervals, and an API credit budget (3{,}000 of 4{,}000 daily) never
exhausted. Two incidents occurred; both were diagnosed from evidence,
fixed at the root, and healed without data loss.
...
Item & Cost & Notes \\
\midrule
DigitalOcean droplet & \$26 & 4\,GB tier resized to 8\,GB; hourly billing, \\
 & & 2026-08-11 to 2026-08-27, destroyed at close \\
Azure (ADLS, ADF, Databricks) & ${\sim}$\$10--15 & against a \$200 credit grant, \\
 & & most of it the one-time medallion build \\
Vercel (frontend + blob) & \$0 & free tier \\
\midrule
Total cash & \textbf{${\sim}$\$26} & against a \$150 budget cap \\
\bottomrule
\end{tabular}
\caption{Project infrastructure cost, complete.}
\end{table}
